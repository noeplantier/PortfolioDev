  ...
  const mockRepositories: Repository[] = [
    {
      id: 1,
      name: 'put.in coffee',
      description: 'Bar booking and ordering PWA for coffee shops — built with Astro, featuring a sleek UI, real-time updates, and offline support.',
      html_url: 'https://github.com/noeplantier/put-in-coffee',
      homepage: 'https://put-in-coffee.netlify.app',
      stargazers_count: 200,
      forks_count: 50,
      language: 'Astro',
      updated_at: '2026-07-06T12:12:39Z',
      topics: ['cafe', 'bar', 'booking'],
      featured: true,
    },

    {
      ...
      homepage: 'https://universestreaming.netlify.app/',
      stargazers_count: 120,
      forks_count: 30,
      language: 'React Native',
      updated_at: '2026-04-21T18:00:00Z',
      topics: ['mobile', 'streaming', 'movies'],
    },
  
    {
      ...
      topics: ['microservices', 'express', 'react'],
    },
 
    {
      id: 4,
      name: 'Plantiers',
      description: 'Software engineering portfolio showcasing a variety of projects, from web apps to mobile solutions, with detailed case studies and live demos.',
      ...
      topics: ['software', 'portfolio', 'prices'],
    },
...

    {
      ...
      homepage: 'https://crypto-compass-saas.netlify.app/',
      stargazers_count: 156,
      forks_count: 45,
      language: 'Glide',
      updated_at: '2024-01-08T09:15:00Z',
      topics: ['mobile', 'coffee', 'booking'],
    },
  
    {
      id: 6,
      name: 'Eventure',
      description: 'Staff organisation and event management platform with real-time updates, calendar integration, and user-friendly dashboards.',
      html_url: 'https://github.com/noeplantier/eventure',
      homepage: '',
      stargazers_count: 75,
      forks_count: 18,
      language: 'React Native',
      updated_at: '2024-02-15T10:00:00Z',
      topics: ['organizer', 'events', 'staff'],
    },
  ];
